...
export default function HeroLayout1(props) {
  const { Card, overrides: overridesProp, ...rest } = props;
  const variants = [
    {
      overrides: {
        ...
        >
          ...
          >
            ...
            <Text
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              children="To bind images, you can simply select the “src” property and bind it to the home’s “image_url” field."
              {...getOverrideProps(
                overrides,
                "Flex.Flex[0].Flex[0].Flex[0].Text[1]"
              )}
